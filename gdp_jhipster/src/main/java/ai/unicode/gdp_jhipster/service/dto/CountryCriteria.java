...
/**
 * Criteria class for the {@link ai.unicode.gdp_jhipster.domain.Country} entity. This class is used
 * in {@link ai.unicode.gdp_jhipster.web.rest.CountryResource} to receive all the possible filtering options from
