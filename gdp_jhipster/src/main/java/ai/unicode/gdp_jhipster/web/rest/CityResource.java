...
/**
 * REST controller for managing {@link ai.unicode.gdp_jhipster.domain.City}.
 */
@RestController
@RequestMapping("/api")
public class CityResource {
     ...
     */
    @GetMapping("/cities")
    public ResponseEntity<List<CityDTO>> getAllCities(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
