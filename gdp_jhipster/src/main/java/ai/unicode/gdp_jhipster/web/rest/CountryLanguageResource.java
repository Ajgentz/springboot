...
import ai.unicode.gdp_jhipster.service.CountryLanguageService;
...
/**
 * REST controller for managing {@link ai.unicode.gdp_jhipster.domain.CountryLanguage}.
 */
@RestController
@RequestMapping("/api")
public class CountryLanguageResource {
    ...
    public ResponseEntity<CountryLanguageDTO> updateCountryLanguage(@Valid @RequestBody CountryLanguageDTO countryLanguageDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, countryLanguageDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<CountryLanguageDTO>> getAllCountryLanguages(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
