package ai.unicode.worldgdp.dao;

import ai.unicode.worldgdp.dao.mapper.CountryRowMapper;
import ai.unicode.worldgdp.model.Country;
...
public class CountryDAO {
    @Autowired
    NamedParameterJdbcTemplate namedParamJdbcTemplate; // = new DBConfiguration().namedParamJdbcTemplate();
    ...
    public int getCountriesCount(Map<String, Object> params) {
        return namedParamJdbcTemplate.queryForObject(
                "SELECT COUNT(*) FROM country c"
                        ...
                        + (!StringUtils.isEmpty(params.get("search")) ? SEARCH_WHERE_CLAUSE : "")
                        + (!StringUtils.isEmpty(params.get("continent")) ? CONTINENT_WHERE_CLAUSE : "")
                        + (!StringUtils.isEmpty(params.get("region")) ? REGION_WHERE_CLAUSE : ""), params, Integer.class);
    }
